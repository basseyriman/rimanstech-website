    ...
    <>
      <header
        className={cn(
          ...
          scrolled
            ? "border-b border-border-light/80 bg-page/90 backdrop-blur-sm"
            : "bg-transparent"
        )}
      >
        <div className="mx-auto flex h-16 max-w-[1440px] items-center justify-between px-5 sm:px-8 md:h-[70px] md:px-10 lg:h-[76px] lg:px-16 xl:px-20">
          ...
          <div className="flex items-center gap-2 lg:hidden">
            ...
            <button
              type="button"
              className="flex h-11 w-11 items-center justify-center rounded-lg border border-border-light text-carbon"
